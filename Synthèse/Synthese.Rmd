...
df <- rbind(df, data.frame(
 ...
 p <- ggplot(df) +
  geom_line(aes(x = start, y = valeurs), size = 1.5, color = "palegreen3") +  # Tracer une ligne continue sans changer de couleur
...
p <- ggplot(df) +
  geom_line(aes(x = start, y = valeurs), size = 1.5, color = "palegreen3") +  # Tracer une ligne continue
