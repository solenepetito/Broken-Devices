...
df <- data.frame(categorie=factor(label_RIDENTIFICATION_PROBLEME, levels = label_RIDENTIFICATION_PROBLEME), valeurs = mat[2,])
...
p <- ggplot(df, aes(x = categorie, y = valeurs)) +
  ...
  labs(title = "Répartition des différents problèmes rencontrés ",
