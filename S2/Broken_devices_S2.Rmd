...
data <- readRDS("data/data.rds") # base de données sur laquelle on va appliquer tous les changements
...
df$Tranches_Age = factor(df$Tranches_Age,labels=c("15-24 ans","25-34 ans","35-49 ans","50-64 ans","65-80 ans"))
...
df_combined$categorie = factor(df_combined$categorie,labels=c("Agriculteurs","Artisans","Cadres","Professions Intermédiaires","Employés","Ouvriers","Retraités","Etudiants","Autres Inactifs"))
...
```{r}
saveRDS(data, file = "data/data1.rds")
```
