...
Combien de personnes AU TOTAL vivent dans votre foyer y compris vous-même ? 
...
Nous allons maintenant nous intéresser aux équipements numériques que vous utilisez : 
```{r}
...
df$REQUIPEMENT = factor(df$REQUIPEMENT,labels=c("Un téléphone mobile (non smartphone)","Un smartphone","Un ordinateur fixe","Un ordinateur portable","Une tablette tactile","Aucun de ces équipements"))
...
**Quelle(s) solution(s) avez-vous mise(s) en place pour pallier ces problèmes identifiés ?**
