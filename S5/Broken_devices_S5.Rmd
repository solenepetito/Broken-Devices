...
df_T1 <- data.frame(Categorie = Categorie, valeurs = matrice_fin[1,], Résolution = factor("Résolu",levels=resolution_label))
df_T2 <- data.frame(Categorie = Categorie, valeurs = matrice_fin[2,], Résolution = factor("Tenté mais pas réussi",levels=resolution_label))
df_T3 <- data.frame(Categorie = Categorie, valeurs = matrice_fin[3,], Résolution = factor("Pas résolu",levels=resolution_label))
