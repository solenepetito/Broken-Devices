...
Modalités 1 : "Mon téléphone fonctionnait bien"
```{r}
# Modalités 1 : "Mon téléphone fonctionnait bien"
...
```{r}
# Modalités 2 : "Il manquait une ou plusieurs fonctionnalités"
...
```{r}
# Modalités 3 : "Mon téléphone était complètement inutilisable"
res = combinaisons_etats(3)
res
```

```{r}
# Modalités 4 : "La durée de vie de la batterie était faible"
res = combinaisons_etats(4)
res
```

```{r}
# Modalités 5 : "Le stockage de mon téléphone était insuffisant"
res = combinaisons_etats(5)
res
```

```{r}
# Modalités 6 : "Mon téléphone était lent"
res = combinaisons_etats(6)
res
```

```{r}
# Modalités 7 : "Mon téléphone était physiquement endommagé"
res = combinaisons_etats(7)
res
```

```{r}
# Modalités 8 : "Mon téléphone avait des dysfonctionnements"
res = combinaisons_etats(8)
res
```

```{r}
# Modalités 9 : "Autre raison"
res = combinaisons_etats(9)
res
```

```{r}
# Modalités 10 : "Je ne me souviens pas"
